...
def initializedb(mode: str) -> None:
    ...
    if mode == "dev":
        ...
        try:
            ...
            chestnut_logger.error(
                "AutogenerateDiffsDetected raised:\n" + autogenerate_exc.args[0],
            )
            chestnut_logger.info(
                "Now will generate migrate scripts and upgrade to database."
            )
            ...
            try:
                ...
                chestnut_logger.error(
                    f"Can't locate revision identified in database {config.get_main_option('sqlalchemy.url')}."
                )
            else:
...
def updatedocs(mode: str) -> None:
    ...
    try:
        ...
        chestnut_logger.error("Here's a error raised:\n" + str(e))
    else:
        chestnut_logger.info("OK.")
